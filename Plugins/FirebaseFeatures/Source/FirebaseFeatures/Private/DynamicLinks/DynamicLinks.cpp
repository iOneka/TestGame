...
#if WITH_FIREBASE_DYNAMIC_LINKS
static bool GHasUnhandledDynamicLink = false;
static FString GLastDynamicLinkURL = {};
static ELinkMatchStrength GLastDynamicLinkStrength = {};

void OnDynamicLinkReceived(const bool bHandled, FString URL, const ELinkMatchStrength Strength)
{
	GHasUnhandledDynamicLink = !bHandled;
	GLastDynamicLinkURL = URL;
	GLastDynamicLinkStrength = Strength;
}
#endif

bool FDynamicLinksLibrary::DidReceiveUnhandledDynamicLink()
{
#if WITH_FIREBASE_DYNAMIC_LINKS
	return GHasUnhandledDynamicLink;
#else
	return false;
#endif
}

void FDynamicLinksLibrary::ClearUnhandledDynamicLink()
{
#if WITH_FIREBASE_DYNAMIC_LINKS
	GHasUnhandledDynamicLink = false;
#endif
}

FString FDynamicLinksLibrary::GetLastDynamicLinkURL()
{
#if WITH_FIREBASE_DYNAMIC_LINKS
	return GLastDynamicLinkURL;
#else
	return {};
#endif
}

ELinkMatchStrength FDynamicLinksLibrary::GetLastDynamicLinkMatchStrength()
{
#if WITH_FIREBASE_DYNAMIC_LINKS
	return GLastDynamicLinkStrength;
#else
	return {};
#endif
}
