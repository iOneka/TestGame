...
#if UE_5_3_OR_LATER
        this.PublicDefinitions.Add("REDPOINT_OSB_UE_5_3_OR_LATER=1");
#endif
#if UE_5_2_OR_LATER
        this.PublicDefinitions.Add("REDPOINT_OSB_UE_5_2_OR_LATER=1");
#endif
#if UE_5_1_OR_LATER
        this.PublicDefinitions.Add("REDPOINT_OSB_UE_5_1_OR_LATER=1");
#endif
#if UE_5_0_OR_LATER
        this.PublicDefinitions.Add("REDPOINT_OSB_UE_5_0_OR_LATER=1");
#endif
#if UE_4_27_OR_LATER
        this.PublicDefinitions.Add("REDPOINT_OSB_UE_4_27_OR_LATER=1");
#endif
#if UE_4_26_OR_LATER
        this.PublicDefinitions.Add("REDPOINT_OSB_UE_4_26_OR_LATER=1");
        this.PublicDefinitions.Add("REDPOINT_OSB_UE_4_25_OR_LATER=1");
        this.PublicDefinitions.Add("REDPOINT_OSB_UE_4_24_OR_LATER=1");
#endif

#if UE_5_3_OR_LATER && !UE_5_4_OR_LATER
        Console.WriteLine("Online Subsystem Blueprints: Targeting Unreal Engine 5.3.");
        this.ConditionalAddModuleDirectory(new DirectoryReference(Path.Combine(this.ModuleDirectory, "..", "OnlineSubsystemBlueprints_5.3")));
#elif UE_5_2_OR_LATER && !UE_5_3_OR_LATER
