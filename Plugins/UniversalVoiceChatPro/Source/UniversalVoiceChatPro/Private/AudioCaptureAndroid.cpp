...
bool UAudioCaptureAndroid::AndroidMicrophoneStart(UMicrophoneSpeakComponent *callbackComp,int sampleRateToUse)
{
	...
	{
		AndroidThunkJava_AndroidStartMicrophone = FJavaWrapper::FindMethod(JavaEnv, FJavaWrapper::GameActivityClassID, "AndroidThunkJava_AndroidStartMicrophone", "(IZ)Z", false);
	}
	...
	jboolean res = FJavaWrapper::CallBooleanMethod(JavaEnv, FJavaWrapper::GameActivityThis, AndroidThunkJava_AndroidStartMicrophone, sampleRateToUse, APlayerVoiceChatActor::useAndroidCommunicationMode);
