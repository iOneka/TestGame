...
bool UUniversalVoiceChat::VoiceChatStartSpeak(bool _shouldHearMyOwnVoice, bool isGlobal, int radioChannel, bool useRange, float maxRange) {
	...
	if (APlayerVoiceChatActor::myPlayerVoiceActor != NULL && IsValid(APlayerVoiceChatActor::myPlayerVoiceActor) && IsValid(APlayerVoiceChatActor::myPlayerVoiceActor->microphoneSpeakComponent)) {
